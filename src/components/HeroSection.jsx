    ...
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20 text-center text-white">
        ...
        <button
          ...
          className="mt-6 py-2 px-5 rounded font-extrabold bg-gradient-to-l from-[#1595b6] to-[#1f2667e6] relative group text-white shadow-lg transition-colors duration-500 hover:from-[#1f2667e6] hover:to-[#1595b6]"
        >
          About Us
        </button>
      </div>
